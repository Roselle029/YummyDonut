...
<div id="top-header">
	   ...
	   <div id="header-image-menu">
		   <center><img src="images/contact.JPG" style="width: 70%; height: 70%;"></center>
	   </div>
   </div>
...
<section class="contact">
   ...
   <div class="row">
      ...
      <div class="image">
      <h1> 1632 Ferrer Street, Central Bicutan, Taguig City, Philippines. </h1>
      ...
      <form action="" method="post">
         ...
         <H1> Fill out the form with your inquiry </H1>
